import 'package:doctor_apps/Model/Data%20Base%20Docter%20Anak.dart';
...
class  SemuaDocter extends StatelessWidget {
  @override
        ...
        child: Column(
          children: [
            ListDock(
                ...
                docterAnak[0].categoriDocter, docterAnak[0].biayaKonsultasi),
            ListDock(
            ...
            ListDock(docterAnak[1].gambaarDoc,
